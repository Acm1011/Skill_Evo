...
def main(args):
    ...
    os.makedirs(args.save_path_dir, exist_ok=True)
    #save_path_dir = args.save_path_dir
    print(f'eval model: {args.model_name} performance on the math dataset: {args.dataset}, eval results will be saved in {args.save_path_dir}, using GPUs: {gpu_ids}')
