...
SE_CODE_MODULE="${SE_CODE_MODULE:-se_code_auto}"
...
SE_SAVED_RESULTS_DIR="${SE_SAVED_RESULTS_DIR:-${SE_BASE_DIR}/saved_results}"
SE_CHALLENGER_DIR="${SE_SAVED_RESULTS_DIR}/Challenger"
SE_SOLVER_DIR="${SE_SAVED_RESULTS_DIR}/Solver"
SE_TENSORBOARD_DIR="${SE_SAVED_RESULTS_DIR}/tensorboard_log"
SE_PROMPT_DIR="${SE_WORKING_DIR}/${SE_CODE_MODULE}"
mkdir -p ${SE_CHALLENGER_DIR} ${SE_SOLVER_DIR} ${SE_TENSORBOARD_DIR} ${SE_PROMPT_DIR}
# =============================================================================
# 辅助函数
# =============================================================================
