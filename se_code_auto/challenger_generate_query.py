...
import json
import regex as re
from se_code_auto.Challenger_dataset import get_prompts
from se_code_auto.reward_manager import custom_extract_boxed_content
def main(args):
    ...
    dataframe=get_prompts(num_querys=args.num_samples, get_prompts_func=args.get_prompts_func)
    prompt = [
    ...
    for idx, completion in enumerate(completions):
        ...
        try:
            ...
            if args.get_prompts_func == "R_Zero" or args.get_prompts_func == "weakness_icl":
