...
from se_code.utils import process_single_R_Zero, process_single_Rule
...
"""
    ...
    def process_single(idx, question, answer, response):
    ...
    for idx, (q, a) in enumerate(zip(questions, answers)):
        try:
            if q and a:
                ...
                response_idx += 1
                item = process_single(idx, q, a, response)
