...
import json
import regex as re
from se_code.Challenger_dataset import get_prompts
...
def main(args):
    ...
    dataframe=get_prompts(num_querys=args.num_samples, get_prompts_func=args.get_prompts_func, prompt_path=args.prompt_path)
    prompt = [
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt_path", type=str, default="/root/users/ycy/Self-evolving-Agent/se_code", help="Path to the prompt")
