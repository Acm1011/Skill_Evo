...
CUDA_VISIBLE_DEVICES=6 python -m se_code.start_vllm_server --port 5002 --model_path $solver_model_path &

CUDA_VISIBLE_DEVICES=7 python -m se_code.start_vllm_server --port 5003 --model_path $solver_model_path &
