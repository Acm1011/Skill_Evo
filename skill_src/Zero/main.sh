...
# =============================================================================
# Offline Rollout 参数
# mult 只放大 offline 采集量 (T×mult)×batch；PPO 仍为 T 步（见 Synthesizer.sh）
# =============================================================================
...
# memory_func_after_sync / memory_hook：与 main_o 一致，便于手动跑 ingest 时继承
export SE_MEMORY_MIN_UTILITY="${SE_MEMORY_MIN_UTILITY:-0}"

# =============================================================================
# Synthesizer RL：PPO 步 = 基座 T；offline driver 步 = T×mult（多采以抗 all-fail）
# =============================================================================
