...
def main(args):
    ...
    save_path_dir = os.path.join(args.save_path_dir, args.model_name, f'step_{args.step}')
    os.makedirs(save_path_dir, exist_ok=True)
    #save_path_dir = args.save_path_dir
    print(f'eval model: {args.model_name} with step {args.step} performance on the math dataset: {args.dataset}, eval results will be saved in {save_path_dir}, using GPUs: {gpu_ids}')
