...
for model_name in model_list:
    if not (model_name.startswith('RR') or model_name.startswith('Qwen3')):
        continue
...
if res:
    ...
    if df_merged is not None:
        ...
        csv_file = os.path.join(eval_dir, f'RR_evolove_eval_results.csv')
        excel_file = os.path.join(eval_dir, f'RR_evolove_eval_results.xlsx')
