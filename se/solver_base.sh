...
# 直接获取参数
exp_name=RR-Zero-V2-Step15-DeepScaleR
solver_model_path=/root/users/ycy/saved_results/Solver/RR-Zero_Qwen3-4B-Base-V2/ckpts/global_step_15/actor/huggingface
solver_training_steps=100
...
TRAIN_FILE=${data_dir}/DeepScaleR-40K.parquet
