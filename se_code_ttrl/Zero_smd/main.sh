...
train_file=${data_dir}/ttrl_${ratio}/${dataset}.parquet
echo "[配置] train_file: ${train_file}"
...
variant=data_${dataset}_${ratio}_${question_reward}_gq${gen_question_func}_${base_model_name}
