...
# AIME24 AIME25 AMC23 MATH500 Minerva OlympiadBench
train_data=$1
model_name=$2
if [ "$train_data" == "AIME24" ]; then
    epoch=80
    train_prompt_bsz=8
    test_freq=20
    save_freq=20
elif [ "$train_data" == "AIME25" ]; then
    epoch=80
    train_prompt_bsz=8
    test_freq=20
    save_freq=20
elif [ "$train_data" == "AMC23" ]; then
    epoch=30
    train_prompt_bsz=8
    test_freq=20
    save_freq=20
elif [ "$train_data" == "MATH500" ]; then
    epoch=10
    train_prompt_bsz=32
    test_freq=20
    save_freq=20
...
echo "================================================"
model_dir=/home/ycy/data1/models
data_dir=/home/ycy/data1/data/ttrl
TRAIN_FILE=${data_dir}/${train_data}.parquet
TEST_FILE=${data_dir}/test_set.parquet
exp_name=ttrl_${model_name}_${train_data}_bsz${train_prompt_bsz}_epoch${epoch}
solver_model_path=${model_dir}/${model_name}

project_name='Self-evolving-Agent-ttrl'
WORKING_DIR=/home/ycy/data1/Self-evolving-Agent
exec > >(tee -a "${WORKING_DIR}/logs/train_${exp_name}-$(now).log") 2>&1
saved_results_dir=/home/ycy/data4/ttrl_saved
solver_path_dir=${saved_results_dir}/Solver_ttrl_Base
...
tensorboard_path=${tensorboard_dir}/Solver_ttrl_Base-${exp_name}
...
# Paths
#data_dir=/home/ycy/data1/data
#TRAIN_FILE=${data_dir}/ttrl/AIME24.parquet
...
python3 -m se_code_ttrl.main_solver_dapo \
    ...
    trainer.experiment_name="ttrl_Base-${exp_name}" \
