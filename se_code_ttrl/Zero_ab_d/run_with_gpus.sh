...
# GPU 空闲判定阈值
GPU_MEMORY_THRESHOLD_MB="${GPU_MEMORY_THRESHOLD_MB:-400}"      # 显存占用低于此值视为空闲(MB)
...
# 基础目录 (可通过环境变量覆盖)
SE_BASE_DIR="${SE_BASE_DIR:-/home/ycy}"
...
SE_SAVED_RESULTS_DIR="${SE_SAVED_RESULTS_DIR:-${SE_BASE_DIR}/ttrl_saved}"
