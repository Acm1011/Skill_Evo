...
# 解析参数
exp_name=test_dynamic_topics_icl
...
topics_path=/root/users/ycy/Self-evolving-Agent/se_code/prompt2/all_topic_annotations.json
...
# 设置日志文件路径
project_name='Self-evolving-Agent-test'
...
# bash challenger_reward.sh $solver_model_path 
# # 等待vLLM服务启动并跟踪进程
# echo "等待vLLM服务启动..."
