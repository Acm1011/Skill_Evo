...
variant=prompt3_icl_se-Zero_${base_model_name}
exp_name=${variant}-V1
...
echo "开始第一轮训练..."
echo "训练 Challenger..."
bash ${SCRIPT_DIR}/challenger.sh $exp_name $base_model_path $base_model_path $challenger_training_steps $topics_path || {
