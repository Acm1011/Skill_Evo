"""python -m baselines.MementoMath <subcommand> ..."""
...
from .build_training_data import build_build_training_data_parser
from .evolve_memory import build_evolve_memory_parser
from .retrieve_memory import build_retrieve_parser
from .train_retriever import build_train_retriever_parser


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Math Memento pipeline (baselines/MementoMath)"
    )
    ...
    build_build_training_data_parser(sub)
