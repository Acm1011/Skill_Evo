#!/usr/bin/env bash
# GSPO variant based on run_qwen3-8b_GRPO.sh
...
TENSORBOARD_DIR="/home/ycy/sdi/skill_saved/Skill_Evo/baseline/tensorboard_log/gspo_qwen3_4b"
...
PROJECT_NAME='verl_gspo_qwen3_4b'
EXPERIMENT_NAME='gspo_qwen3_4b'
