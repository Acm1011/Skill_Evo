...
#
# 路径与超参均在下方配置块中修改；命令行可追加 Hydra 覆盖项，例如:
...
TENSORBOARD_DIR="/home/ycy/sdi/skill_saved/Skill_Evo/baseline/tensorboard_log/grpo_skillrl_qwen3_4b"
TRAIN_FILES="/home/ycy/sdi/Skill_Evo/baselines/SkillRL/outputs/deepmath_skills_rl.parquet"
VAL_FILES="/home/ycy/sdi/data/temp_data.parquet"
MODEL_PATH="/home/ycy/sdi/models/Qwen3-4B-Instruct-2507"
PROJECT_NAME='skillrl_qwen3_4b'
EXPERIMENT_NAME='skillrl_grpo_qwen3_4b'
