...
def _prepare_env_kwargs(env_kwargs, is_train: bool):
...
class TrajectoryCollector:
    ...
    def vanilla_multi_turn_loop(
        ...
        env_kwargs = _prepare_env_kwargs(gen_batch.non_tensor_batch.pop('env_kwargs', None), is_train=is_train)
